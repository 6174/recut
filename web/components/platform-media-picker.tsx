 ...
 * [OUTPUT]: 对外提供 iframe App 可调用、支持按类型上传和单选/多选的全局素材选择器，限制完成态和指定媒体类型
