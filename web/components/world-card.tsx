 ...
 * 本地/平台世界图片证据单图轮播预览（previewAssetIds/previewUrls，箭头+计数）、名称、定位、实体计数摘要与可选封面；点击整卡进入 /worlds/{id}
