 ...
 * [OUTPUT]: 对外提供根布局挂载的全局工作台壳：顶部由页面渲染的 Header 横贯全宽，其下 Body 左侧为页面内容、右侧为全局 Agent 侧栏；单实例侧栏从 headerHeight 起向下铺满、跨路由持久宽度并带拖动手柄，页面内容用 `--side-panel-width` 预留右侧空间，只经 context 声明素材上下文与草稿
