...
import { requiresMediaId } from "@timeline/timeline/element-utils";
import type { MediaAsset } from "@timeline/media/types";
import { DEFAULT_NEW_ELEMENT_DURATION } from "@timeline/timeline/creation";
import { floatToFrameRate } from "@timeline/fps/utils";
import { graphicsRegistry, registerDefaultGraphics } from "@timeline/graphics";
import {
	applyPlacement,
	canElementGoOnTrack,
