            ...
            Color.black
                .colorEffect(
                    ShaderLibrary.peaks(
                        ...
                        .float2(0.86, 0.52),
                        .float2(0.5, 1.0),
                        .color(Color(hex: "#FAFBFF")),
                        .color(Color(hex: "#000000")),
                        .color(Color(hex: "#E7EEFF")),
                        .color(Color(hex: "#9DBBFF")),
                        .color(Color(hex: "#2E5CFF")),
                        .color(Color(hex: "#0A1030")),
                        .color(Color(hex: "#285FFF")),
                        .color(Color(hex: "#0041FF")),
                        .color(Color(hex: "#00030F")),
                        .color(Color(hex: "#000208")),
                        .color(Color(hex: "#000000")),
                        .color(Color(hex: "#2E5CFF")),
                        .float(0.0),
                        .float(0.5),
