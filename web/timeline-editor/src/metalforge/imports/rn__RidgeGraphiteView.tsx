...
const float layer1Blur = 38.0;
const float layer2Blur = 24.0;
const float layer3Blur = 18.0;
const float grainAmt = 0.2;
const float grainFreq = 0.8;
...
const half4 layer1Color = half4(0.72549, 0.760784, 0.823529, 1.0);
const half4 layer2Color = half4(0.231373, 0.266667, 0.32549, 1.0);
const half4 layer3Color = half4(0.027451, 0.035294, 0.047059, 1.0);
const half4 shadowColor = half4(0.235294, 0.27451, 0.352941, 1.0);
...
export default function RidgeGraphiteView() {
