            ...
            Color.black
                .colorEffect(
                    ShaderLibrary.duotone(
                        ...
                        .color(Color(hex: "#B32A8B")),
                        .color(Color(hex: "#5B1FA2")),
                        .color(Color(hex: "#1B1E6B")),
                        .color(Color(hex: "#05060F")),
                        .color(Color(hex: "#000000")),
                        .color(Color(hex: "#FF7896")),
                        .color(Color(hex: "#04050E")),
                        .color(Color(hex: "#FF2D55")),
                        .float(0.0),
                        .float(0.5),
                        .float(5.0),
