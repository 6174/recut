...
const half4 bgColor = half4(0.019608, 0.023529, 0.015686, 1.0);
const half4 mound1Color = half4(0.309804, 0.619608, 0.0, 1.0);
const half4 mound2Color = half4(0.713725, 0.960784, 0.235294, 1.0);
const half4 poolTint = half4(0.784314, 0.980392, 0.470588, 1.0);
const half4 dotColor = half4(1.0, 1.0, 1.0, 1.0);
const half4 borderColor = half4(1.0, 1.0, 1.0, 1.0);
const half4 shadowColor = half4(0.713725, 0.960784, 0.235294, 1.0);
