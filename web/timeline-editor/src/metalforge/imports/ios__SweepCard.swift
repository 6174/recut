            ...
            Color.black
                .colorEffect(
                    ShaderLibrary.sweep(
                        ...
                        .float2(0.86, 0.52),
                        .float2(0.3, 1.0),
                        .color(Color(hex: "#140518")),
                        .color(Color(hex: "#FFE0FC")),
                        .color(Color(hex: "#F23DDB")),
                        .color(Color(hex: "#570D75")),
                        .color(Color(hex: "#060308")),
                        .color(Color(hex: "#9E1ABD")),
                        .color(Color(hex: "#F032BE")),
                        .float(0.0),
                        .float(0.5),
                        .float(5.0),
                        .float(8.0),
