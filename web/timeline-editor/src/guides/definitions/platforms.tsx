...
export const igReelsGuide: GuideDefinition = {
	...
	labelKey: "guide.reels",
};
export const ytShortsGuide: GuideDefinition = {
	...platformGuide({ id: "yt-shorts", label: "Shorts", domain: "youtube.com" }),
	labelKey: "guide.shorts",
};
export const spotlightGuide: GuideDefinition = {
	...platformGuide({ id: "spotlight", label: "Spotlight", domain: "snapchat.com" }),
	labelKey: "guide.spotlight",
};
