/**
 * [INPUT]: 依赖预览 Store、网格约束与统一 NumberField。
 * [OUTPUT]: 对外提供画布网格辅助线及其行列设置定义。
 * [POS]: guides/definitions 的网格实现，行列输入遵循全局数值拖拽规范。
...
import {
	...
	GRID_MAX,
	DEFAULT_GRID_CONFIG,
} from "@timeline/guides/grid";
import { usePreviewStore } from "@timeline/preview/preview-store";
import { clampRound } from "@timeline/utils/math";
import { cn } from "@timeline/utils/ui";
import type { GuideDefinition } from "@timeline/guides/types";
