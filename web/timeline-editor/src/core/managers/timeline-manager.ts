...
import type { ElementBounds } from "@timeline/preview/element-bounds";
...
import { calculateTotalDuration } from "@timeline/timeline";
import { TimelineDragSource } from "@timeline/timeline/drag-source";
import { findTrackInSceneTracks } from "@timeline/timeline/track-element-update";
import { broadcastChangedSubtitleTracks } from "@timeline/subtitles/shared-style";
import { lastFrameMediaTime, type MediaTime, ZERO_MEDIA_TIME } from "@timeline/wasm";
import {
	canElementBeHidden,
	canElementHaveAudio,
} from "@timeline/timeline/element-utils";
import { isElementMuted } from "@timeline/timeline/audio-state";
import type {
	AnimationPath,
	AnimationInterpolation,
	ScalarCurveKeyframePatch,
} from "@timeline/animation/types";
import type { ParamValue } from "@timeline/params";
import {
	getElementLocalTime,
	hasKeyframesForPath,
	resolveAnimationPathValueAtTime,
	upsertPathKeyframe,
} from "@timeline/animation";
import { NUMBER_CHANNEL_LAYOUT } from "@timeline/params";
import { buildTransformFromParams, type Transform } from "@timeline/rendering";
import { resolveAnimationTarget } from "@timeline/timeline/animation-targets";
...
} from "@timeline/commands/timeline";
import type { InsertElementParams } from "@timeline/commands/timeline/element/insert-element";
import type {
	PlannedElementMove,
	PlannedTrackCreation,
} from "@timeline/timeline/group-move";
import type { NodeOverlay } from "@timeline/core/state/ephemeral-layer";
