...
import type { Command, CommandResult } from "@timeline/commands";
import type { EditorSelectionSnapshot } from "@timeline/selection/editor-selection";
import { applyRippleAdjustments, computeRippleAdjustments } from "@timeline/ripple";
import type { SceneTracks } from "@timeline/timeline/types";
