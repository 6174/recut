...
import { resolveAnimationPathValueAtTime } from "@timeline/animation";
import {
	Section,
	SectionHeader,
	SectionTitle,
} from "@timeline/components/section";
import { useElementPlayhead } from "@timeline/components/editor/panels/properties/hooks/use-element-playhead";
import { useKeyframedParamProperty } from "@timeline/components/editor/panels/properties/hooks/use-keyframed-param-property";
import { PropertyParamField } from "@timeline/components/editor/panels/properties/components/property-param-field";
import { ParamGroups } from "@timeline/components/editor/panels/properties/components/param-groups";
import type { ParamDefinition, ParamValue } from "@timeline/params";
import { componentsRegistry, getComponentName } from "@timeline/runtime";
import type { TimelineElement } from "@timeline/timeline";
import type { MediaTime } from "@timeline/wasm";
import { useRecutLocale } from "@timeline/i18n";
...
function supportsCapturePadding(definition: import("@timeline/runtime/types").ComponentDefinition): boolean {
