...
import { Section, SectionContent, SectionHeader, SectionTitle } from "@timeline/components/section";
...
import { addMediaTime, mediaTimeFromSeconds, mediaTimeToSeconds, type MediaTime } from "@timeline/wasm";
import {
	MOTION_PRESETS,
	applyMotionPreset,
	componentsRegistry,
