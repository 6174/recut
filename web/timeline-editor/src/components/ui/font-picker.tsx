...
import { loadFullFont } from "@timeline/fonts/google-fonts";
import {
	uploadLocalFont,
	deleteLocalFont,
	registerUploadedFont,
} from "@timeline/fonts/service-catalog";
import { SYSTEM_FONTS } from "@timeline/fonts/system-fonts";
import {
	useFontAtlas,
	type FontSourceItem,
} from "@timeline/fonts/use-font-atlas";
	...
	useEffect(() => {
		...
		const load = async () => {
			const { listLocalFonts: list } = await import(
				"@timeline/fonts/service-catalog"
			);
