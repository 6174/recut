...
import { isGuideId, type GuideId } from "@timeline/guides";
import { DEFAULT_GRID_CONFIG } from "@timeline/guides/grid";
import type { GridConfig } from "@timeline/guides/types";
