...
import { EditableTimecode } from "@timeline/components/editable-timecode";
...
import { PREVIEW_ZOOM_PRESETS } from "@timeline/preview/zoom";
...
function ZoomSelect() {
	...
	const displayLabel = isAtFit ? t(locale, "preview.fit") : `${zoomPercent}%`;
	...
	return (
		...
		>
			...
			<SelectContent>
				<SelectItem value="fit">{t(locale, "preview.fit")}</SelectItem>
				<SelectSeparator />
