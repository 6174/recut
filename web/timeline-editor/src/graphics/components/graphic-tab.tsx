...
} from "@timeline/components/editor/panels/properties/hooks/use-keyframed-param-property";
import type { ParamDefinition, ParamValues } from "@timeline/params";
import type { GraphicElement } from "@timeline/timeline";
import { graphicsRegistry, registerDefaultGraphics, resolveGraphicElementParamsAtTime, getGraphicName } from "@timeline/graphics";
	...
	return (
		<div className="flex flex-col">
			<Section collapsible sectionKey={`${element.id}:graphic`}>
				<SectionHeader>
					<SectionTitle>
						{getGraphicName({ definition, locale })}
					</SectionTitle>
				</SectionHeader>
				<SectionContent>
					<SectionFields>
...
function StrokeSection({
	...
	return (
		...
		>
			...
			>
				<SectionTitle>{t(locale, "prop.group.stroke")}</SectionTitle>
			</SectionHeader>
			<SectionContent
