...
import { addMediaTime, mediaTimeFromSeconds, ZERO_MEDIA_TIME } from "@timeline/wasm";
import type { CreateTextElement } from "@timeline/timeline";
import type { ParamValues } from "@timeline/params";
import type { TextBackground } from "@timeline/text/background";
import type {
	TextAlign,
	TextDecoration,
	TextFontStyle,
