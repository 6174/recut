...
import { PanelView } from "@timeline/components/editor/panels/assets/views/base-panel";
import {
	Select,
	SelectContent,
	SelectItem,
...
import { extractTimelineAudio } from "@timeline/media/mediabunny";
import { timelineHasAudio } from "@timeline/media/audio";
import type { MediaAsset } from "@timeline/media/types";
import { TRANSCRIPTION_DIAGNOSTICS_SCOPE } from "@timeline/transcription/diagnostics";
import type { CaptionChunk, TranscriptionSegment } from "@timeline/transcription/types";
import { buildCaptionChunks } from "@timeline/transcription/caption";
import { insertCaptionChunksAsTextTrack } from "@timeline/subtitles/insert";
import type { CaptionSource } from "@timeline/subtitles/types";
import { parseSubtitleFile } from "@timeline/subtitles/parse";
import {
	fetchRecutSubtitleCues,
	pickRecutSubtitle,
} from "@timeline/subtitles/from-recut";
...
import { Spinner } from "@timeline/components/ui/spinner";
import {
	Section,
	SectionContent,
	SectionField,
...
import type { DiagnosticSeverity } from "@timeline/diagnostics/types";
