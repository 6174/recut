...
import type {
	...
	TextMaskParams,
	MaskHandleId,
} from "@timeline/masks/types";
import { DEFAULTS } from "@timeline/timeline/defaults";
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from "@timeline/text/typography";
import {
	drawMeasuredTextLayout,
	measureTextLayout,
	strokeMeasuredTextLayout,
} from "@timeline/text/primitives";
import { getTextMeasurementContext } from "@timeline/text/measure-element";
import { getTextVisualRect } from "@timeline/text/layout";
import {
	getBoxMaskHandlePositions,
	getBoxMaskRectOverlay,
} from "@timeline/masks/handle-positions";
import { computeFeatherUpdate } from "@timeline/masks/param-update";
import {
	setMaskLocalCenter,
	toGlobalMaskSnapLines,
} from "@timeline/masks/geometry";
import {
	snapPosition,
	snapRotation,
	snapScale,
