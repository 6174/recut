import {
	...
	MIN_MASK_DIMENSION,
} from "@timeline/masks/dimensions";
...
import type { NumberParamDefinition, ParamDefinition } from "@timeline/params";
import {
	getBoxMaskHandlePositions,
	getBoxMaskOverlays,
} from "@timeline/masks/handle-positions";
import { snapBoxMaskInteraction } from "@timeline/masks/snap";
