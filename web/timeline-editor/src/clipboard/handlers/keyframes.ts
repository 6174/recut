...
import { getChannelEntriesFromData } from "@timeline/animation/channel-data";
import { isScalarChannel } from "@timeline/animation/interpolation";
import type { SelectedKeyframeRef } from "@timeline/animation/types";
import type { TimelineElement } from "@timeline/timeline";
import { PasteKeyframesCommand } from "@timeline/commands/timeline";
import type {
	ClipboardHandler,
	KeyframeClipboardCurvePatch,
	KeyframeClipboardItem,
} from "../types";
import { roundMediaTime, subMediaTime, type MediaTime } from "@timeline/wasm";
