...
import { buildDefaultEffectInstance } from "@timeline/effects";
import { buildDefaultGraphicInstance } from "@timeline/graphics";
...
import { capitalizeFirstLetter } from "@timeline/utils/string";
import { type MediaTime, ZERO_MEDIA_TIME } from "@timeline/wasm";
...
export function buildComponentElement({
	componentId,
	name,
	startTime,
	params,
	...
	return {
		...
		params: mergeParamValues({
			base: {
				...buildDefaultElementParams({ type: "component" }),
				...buildDefaultParamValues(definition.inputs),
			},
			overrides: params,
		}),
		duration: DEFAULT_NEW_ELEMENT_DURATION,
