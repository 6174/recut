...
import type { TimelineElement as TimelineElementType } from "@timeline/timeline";
import { TIMELINE_LAYERS } from "./layers";
import type { ElementDragView } from "@timeline/timeline";
	...
	return (
		<div className="relative size-full">
			<button
				...
				aria-label={t(locale, "timeline.selectTrack", { name: track.name })}
				onMouseUp={(event) => {
