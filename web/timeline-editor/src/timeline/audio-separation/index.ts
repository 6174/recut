...
import { t, type I18nKey, type RecutLocale } from "@timeline/i18n";
...
export function getSourceAudioActionKey({
	element,
}: {
	element: VideoElement;
}): I18nKey {
...
export function getSourceAudioActionText({
	element,
	locale,
}: {
	element: VideoElement;
	...
	return t(locale, getSourceAudioActionKey({ element }));
}
