/**
 * [INPUT]: 依赖场景、轨道与时间计算工具，负责场景默认值和兼容性修复。
 * [OUTPUT]: 对外提供场景选择、创建、时长计算与轨道布局规范化函数。
 * [POS]: timeline 的场景级模型；场景默认值、选择与时长计算。
...
import { MAIN_TRACK_NAME } from "@timeline/timeline/placement/main-track";
