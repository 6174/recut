...
} from "@timeline/animation/effect-param-channel";
import {
	parseGraphicParamPath,
} from "@timeline/animation/graphic-param-channel";
import { effectsRegistry, registerDefaultEffects } from "@timeline/effects";
import { getGraphicDefinition } from "@timeline/graphics";
import {
	coerceParamValue,
...
import { componentsRegistry } from "@timeline/runtime/component-registry";
