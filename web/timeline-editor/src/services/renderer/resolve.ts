import { mediaTimeToSeconds, roundMediaTime } from "@timeline/wasm";
import { getElementLocalTime, resolveAnimationPathValueAtTime } from "@timeline/animation";
import { resolveEffectParamsAtTime } from "@timeline/animation/effect-param-channel";
import {
	buildGaussianBlurPasses,
	intensityToSigma,
} from "@timeline/effects/definitions/blur";
import { effectsRegistry, resolveEffectPasses } from "@timeline/effects";
import type { Effect, EffectPass } from "@timeline/effects/types";
import type { ParamValue } from "@timeline/params";
import { getSourceTimeAtClipTime } from "@timeline/retime";
import {
	DEFAULT_GRAPHIC_SOURCE_SIZE,
	resolveGraphicElementParamsAtTime,
} from "@timeline/graphics";
import {
	buildTextBackgroundFromElement,
	getTextMeasurementContext,
	measureTextElement,
} from "@timeline/text/measure-element";
import { resolveColorAtTime, resolveOpacityAtTime } from "@timeline/animation/values";
