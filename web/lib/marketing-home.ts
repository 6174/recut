...
export const HOME_FAQ: Record<Locale, HomeFaqItem[]> = {
  zh: [
    ...
    },
    {
      ...
      answer: "支持 macOS（Apple 芯片与 Intel）与 Windows。基础剪辑很轻量；本地转写字幕建议 16 GB 内存以上，创建声音角色和 AI 配音建议 32 GB；NVIDIA CUDA 显卡能显著加速转写与配音，Apple 芯片、Intel Mac 与纯 CPU 也能运行。Linux 与 FreeBSD 暂不随发布提供，可在宿主机从源码构建。",
    },
    {
...
export const HOW_IT_WORKS: Record<Locale, HowItWorksItem[]> = {
  zh: [
    { step: "01", title: "安装本地 service", description: "一条命令或安装包完成，支持 macOS（Apple 芯片与 Intel）与 Windows。" },
  ...
  en: [
    { step: "01", title: "Install the local service", description: "Done in one command or installer, available on macOS (Apple silicon and Intel) and Windows." },
