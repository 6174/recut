...
const cases = [
  ...
  ["/worlds 出英文世界观页", "recut.video", "/worlds/", {}, { status: 200, bodyContains: "Worlds catalog" }],
  ["zh 浏览器 /worlds → 302 /zh/worlds/", "recut.video", "/worlds", { "accept-language": "zh-CN" }, { status: 302, location: "/zh/worlds/" }],
  ["/zh/worlds/ 出中文世界观页", "recut.video", "/zh/worlds/", {}, { status: 200, bodyContains: "世界观目录" }],
