...
const STUDIO_HOME_ORDER = ["recut.editor", "recut.audio-studio", "recut.remotion-studio", "recut.ai-short-film", "recut.cover-studio", "recut.depth-anything"];
const PROJECT_APP_ORDER = ["recut.editor", "recut.ai-short-film", "recut.remotion-studio", "recut.audio-studio", "recut.cover-studio", "recut.depth-anything"];
...
function AssetPreview({ apiBase, asset }: { apiBase: string; asset: Asset }) {
  ...
  const icon = asset.kind === "audio" ? <Music2 className="size-5" /> : asset.kind === "video" ? <Video className="size-5" /> : asset.kind === "transcript" ? <Captions className="size-5" /> : asset.kind === "document" ? <Link2 className="size-5" /> : <FileImage className="size-5" />;
