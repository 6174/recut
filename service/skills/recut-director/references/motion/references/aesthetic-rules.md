> 来源: recut/recut — apps/remotion-studio/skills/remotion-studio/references/aesthetic-rules.md (Recut 自有，内部复用)
...
判例：用户（2026-07-25）："里面有几个镜头，你可以发现它配的字很小……现在那些镜头里面的字太小了，根本就看不见"。审查参考介绍片：S1/S2/S4 字幕 38–40px（约 3.5% 帧高）、S6 副句 30px、收尾 URL 25px 全部低于线，其中 S2 面板"为可读性重排"的副标题只给了 19px——重排却没达标即中间态反例；六处统一提到 60/40/34px 档后整改通过。
