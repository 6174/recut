...
| 点击确认 | 两圈同心强调色 ripple（起点差 3f、各 10f、半径 14→54/78）+ 3px 描边 + 40px 辉光，随后相机 16f 推进 zoom 2.2 | 单圈 ripple 太轻看不见；推进交棒给 flash-cut 盖住换页硬切（组件见 /remotion-kit/components/FlashCut.tsx，用法：from = 切点 − 5，跨骑硬切两侧各 5f） |
