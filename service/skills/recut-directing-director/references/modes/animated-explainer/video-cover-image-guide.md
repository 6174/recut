...
本指南用于为动画解说视频生成、修改、对比和质检带字封面、缩略图、标题卡或海报式主视觉。封面属于 `director` 的 Animated Explainer 生产环节，不是独立 skill。
...
3. 代表本期内容的单一视觉命题。
4. 已确认主要人物参考节点及其职责。
5. 已确认 style 的稳定文字视觉语言；封面不生成或连接独立场景／画风参考图。
...
- 人物参考图只承担人物身份、相貌、比例、服装与材质职责，封面 Prompt 按实际连接顺序逐张说明人物身份；整体画风直接使用已确认 style 的稳定文字视觉语言描述，不生成或连接独立场景／画风参考图。
- 保持人物的脸、年龄、发型、服装和可识别轮廓，不把一个人物参考套给其他角色。
- 群演没有独立参考时，统一使用所选 style 的媒介、造型语言、材质、比例、配色和光影，不复制参考人物的具体脸和服装。
...
3. 按 [`tools/libtv-cli.md`](../../tools/libtv-cli.md) 中的 LibTV 专属模型别名解析用户模型名。
