...
const float flow = 0.38;
const float turbulence = 0.28;
const float scale = 2.4;
const float marble = 2.2;
const float wobble = 0.0;
const float shimmer = 0.1;
...
const float innerGlow = 0.5;
const float halo = 0.2;
...
const float2 light = float2(0.62, -0.7);
const half4 colorA = half4(0.239216, 0.054902, 0.007843, 1.0);
const half4 colorB = half4(1.0, 0.239216, 0.0, 1.0);
const half4 colorC = half4(1.0, 0.694118, 0.6, 1.0);
...
const half4 glowColor = half4(1.0, 0.239216, 0.0, 1.0);
const half4 paletteStop0 = half4(0.239216, 0.054902, 0.007843, 1.0);
const half4 paletteStop1 = half4(0.384314, 0.070588, 0.0, 1.0);
const half4 paletteStop2 = half4(0.709804, 0.094118, 0.0, 1.0);
const half4 paletteStop3 = half4(0.960784, 0.207843, 0.0, 1.0);
const half4 paletteStop4 = half4(1.0, 0.258824, 0.047059, 1.0);
const half4 paletteStop5 = half4(1.0, 0.415686, 0.262745, 1.0);
const half4 paletteStop6 = half4(1.0, 0.607843, 0.490196, 1.0);
const half4 paletteStop7 = half4(1.0, 0.694118, 0.6, 1.0);
const half4 paletteStop8 = half4(1.0, 0.694118, 0.6, 1.0);
const half4 paletteStop9 = half4(1.0, 0.694118, 0.6, 1.0);
const half4 paletteStop10 = half4(1.0, 0.694118, 0.6, 1.0);
const half4 paletteStop11 = half4(1.0, 0.694118, 0.6, 1.0);
...
const float LQO_LOOP  = 6.5;
const float LQO_SOFT  = 1.3;
const float LQO_GRAIN = 0.08;
...
export default function OrbEmberView() {
