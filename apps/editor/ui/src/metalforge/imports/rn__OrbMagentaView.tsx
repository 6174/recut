...
const half4 colorA = half4(0.94902, 0.352941, 0.929412, 1.0);
const half4 colorB = half4(1.0, 1.0, 1.0, 1.0);
...
const half4 glowColor = half4(0.94902, 0.352941, 0.929412, 1.0);
const half4 paletteStop0 = half4(0.94902, 0.352941, 0.929412, 1.0);
const half4 paletteStop1 = half4(0.960784, 0.388235, 0.941176, 1.0);
const half4 paletteStop2 = half4(0.988235, 0.482353, 0.968627, 1.0);
const half4 paletteStop3 = half4(1.0, 0.615686, 0.988235, 1.0);
const half4 paletteStop4 = half4(1.0, 0.756863, 0.996078, 1.0);
const half4 paletteStop5 = half4(1.0, 0.882353, 0.996078, 1.0);
const half4 paletteStop6 = half4(1.0, 0.968627, 1.0, 1.0);
...
const float LQO_LOOP  = 7.0;
const float LQO_SOFT  = 1.4;
const float LQO_GRAIN = 0.055;
...
float3 lqo_pal(float x, float3 A, float3 B) {
    float s = clamp(x, 0.0, 1.0);
    float f = s * s * (3.0 - 2.0 * s);
    float3 c = mix(A, B, f);
