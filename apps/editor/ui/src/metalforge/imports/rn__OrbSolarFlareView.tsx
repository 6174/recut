...
const float flow = 0.28;
const float turbulence = 0.14;
const float scale = 1.5;
const float marble = 1.5;
...
const float rim = 0.7;
const float glint = 0.4;
const float innerGlow = 0.85;
const float halo = 0.6;
const float grain = 1.0;
const float seed = 13.0;
...
const half4 colorA = half4(1.0, 0.427451, 0.0, 1.0);
const half4 colorB = half4(1.0, 0.768627, 0.0, 1.0);
const half4 colorC = half4(1.0, 0.992157, 0.905882, 1.0);
...
const half4 glowColor = half4(1.0, 0.768627, 0.0, 1.0);
const half4 paletteStop0 = half4(1.0, 0.427451, 0.0, 1.0);
const half4 paletteStop1 = half4(1.0, 0.482353, 0.0, 1.0);
const half4 paletteStop2 = half4(1.0, 0.623529, 0.0, 1.0);
const half4 paletteStop3 = half4(1.0, 0.74902, 0.0, 1.0);
const half4 paletteStop4 = half4(1.0, 0.780392, 0.121569, 1.0);
const half4 paletteStop5 = half4(1.0, 0.858824, 0.45098, 1.0);
const half4 paletteStop6 = half4(1.0, 0.94902, 0.768627, 1.0);
const half4 paletteStop7 = half4(1.0, 0.992157, 0.905882, 1.0);
const half4 paletteStop8 = half4(1.0, 0.992157, 0.905882, 1.0);
const half4 paletteStop9 = half4(1.0, 0.992157, 0.905882, 1.0);
const half4 paletteStop10 = half4(1.0, 0.992157, 0.905882, 1.0);
const half4 paletteStop11 = half4(1.0, 0.992157, 0.905882, 1.0);
...
const float LQO_LOOP  = 7.5;
const float LQO_SOFT  = 2.0;
...
export default function OrbSolarFlareView() {
