            ...
            Color.black
                .colorEffect(
                    ShaderLibrary.halo(
                        ...
                        .float2(0.86, 0.52),
                        .float2(0.5, 1.0),
                        .color(Color(hex: "#191820")),
                        .color(Color(hex: "#191820")),
                        .color(Color(hex: "#DFCFF8")),
                        .color(Color(hex: "#7052FF")),
                        .color(Color(hex: "#156BFC")),
                        .color(Color(hex: "#062277")),
                        .color(Color(hex: "#141320")),
                        .color(Color(hex: "#7052FF")),
                        .float(0.0),
                        .float(0.5),
                        .float(5.0),
