...
const float layer1Blur = 44.0;
const float layer2Blur = 28.0;
const float layer3Blur = 20.0;
const float grainAmt = 0.2;
const float grainFreq = 0.78;
...
const half4 layer1Color = half4(0.482353, 0.447059, 1.0, 1.0);
const half4 layer2Color = half4(0.164706, 0.117647, 0.619608, 1.0);
const half4 layer3Color = half4(0.019608, 0.015686, 0.094118, 1.0);
const half4 shadowColor = half4(0.329412, 0.282353, 1.0, 1.0);
