...
const half4 bgColor = half4(0.015686, 0.015686, 0.023529, 1.0);
const half4 mound1Color = half4(0.231373, 0.121569, 0.878431, 1.0);
const half4 mound2Color = half4(0.541176, 0.419608, 1.0, 1.0);
const half4 poolTint = half4(0.784314, 0.737255, 1.0, 1.0);
const half4 dotColor = half4(1.0, 1.0, 1.0, 1.0);
const half4 borderColor = half4(1.0, 1.0, 1.0, 1.0);
const half4 shadowColor = half4(0.541176, 0.419608, 1.0, 1.0);
...
export default function SpikePurpleView() {
