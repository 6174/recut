...
```text
apps/             App 包：每个包保存 manifest.json、JS/UI 与领域 AGENTS.md
...
- 每个 Codex turn 由 Go 后端内嵌的 `service/prompts/core-agents.md.tmpl` 渲染平台 guide，并注入当前 App 自己的 `AGENTS.md`；渲染结果写入项目临时 `AGENTS.md`，再按 manifest 选择 App 工具。
